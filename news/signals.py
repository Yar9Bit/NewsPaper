...
from .models import Post, CategorySubscribe


@receiver(post_save, sender=Post)
def notify_post_create(instance):
    ...
    for cat_id in category_id:
        ...
        subscribers_list = list(
            CategorySubscribe.objects.filter(category_thru=cat_id).values_list('subscribers_id', flat=True))
